...
#define FASTRPC_IOCTL_GET_DSP_INFO_LEGACY \
...
/*
 * Android 15 / newer Qualcomm userspace queries one capability at a time.
 * Keep the legacy all-attributes ABI above for older vendor userspace.
 */
